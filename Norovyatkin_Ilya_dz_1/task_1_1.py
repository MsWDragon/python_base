...
# Используем цикл for для проверки работоспособности кода для нескольких значений сразу
